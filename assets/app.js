...
const ROLE_GUARDS_BY_PAGE = {
  ...
  "admin-event-hosts.html": ["admin"],
  "admin-artists.html": ["admin"],
  "admin-sponsors.html": ["admin"],
  "admin-influencers.html": ["admin"],
...
const ADMIN_SECTION_BY_PAGE = {
  ...
  "admin-event-hosts.html": "event-hosts-section",
  "admin-artists.html": "artists-section",
  "admin-sponsors.html": "sponsors-section",
  "admin-influencers.html": "influencers-section"
};
